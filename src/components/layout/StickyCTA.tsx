...
export default function StickyCTA() {
  ...
  return (
    <div
      ...
      aria-hidden={!visible}
    >
      <BookACallButton aria-label="Book a strategy call" className="group flex items-center gap-2.5 px-5 py-3 rounded-full bg-white/[0.08] backdrop-blur-xl border border-white/[0.1] text-white text-sm font-medium shadow-[0_4px_24px_rgba(0,0,0,0.4)] hover:bg-white/[0.12] hover:border-white/[0.16] hover:shadow-[0_4px_32px_rgba(99,102,241,0.2)] transition-all duration-300 cursor-pointer">
